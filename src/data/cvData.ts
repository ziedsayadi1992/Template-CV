...
export const CV_DATA: CVData = {
  ...
  profile: "Développeur Web & Mobile passionné avec 4 ans d'expérience en développement front-end et back-end. Expert en React, Node.js, Drupal et Symfony, j'ai contribué à la conception et au déploiement de solutions digitales innovantes pour des entreprises de renom telles que Thales. Mon approche se concentre sur l'optimisation des performances, la sécurité robuste et l'excellence de l'expérience utilisateur, tout en respectant les meilleures pratiques du développement moderne.",
  contact: {
  ...
  technologies: [
    "PHP 7 / Symfony / PhpUnit / NodeJS / ExpressJs / PrestaShop / Drupal",
    "JavaScript / TypeScript / Redux / ReactJs / HTML / CSS / SASS",
    "Mysql / MariaDb / Sql Server / MongoDB / Redis",
    "React Native",
    "OVH / Docker / Docker-Compose",
    "UML / MVC / REST / SOAP / Json "
  ],
  experiences: [
    {
      id: "1",
